...
dogfood sessions: add source material, approve generated quiz drafts, review
items, persist results, and inspect what happened.
...
- [ ] A code-level test drives source creation, draft approval, queue
      selection, answer submission, reveal, grade/apply-review, next item, and
...
- [ ] The interface displays review-state projection, expected answer after
      reveal/submit, attempt outcome, schedule change, and next queue item.
